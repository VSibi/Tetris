 ...
 */
public class Figure_L_Right extends Figure{
    ...
    public void rotate() {
        switch (mStateOfRotation) {
            case "Normal":
                ...
                mCoord2.set(super.getBasicPoint().x + 1, super.getBasicPoint().y - 2);
            ...
            case "Rotate_90_degrees" :
                ...
                mCoord1.set(super.getBasicPoint().x - 2, super.getBasicPoint().y - 1);
    ...
    public Figure_L_Right clone() {
        Figure_L_Right o = (Figure_L_Right) super.clone();
