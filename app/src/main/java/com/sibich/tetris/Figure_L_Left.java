 ...
 */
public class Figure_L_Left extends Figure{
    ...
    public void rotate() {
        switch (mStateOfRotation) {
            ...
            case "Rotate_90_degrees" :
                super.setBasicPoint(super.getBasicPoint().x - 2, super.getBasicPoint().y);
                mCoord1.set(super.getBasicPoint().x, super.getBasicPoint().y - 1);
                mCoord2.set(super.getBasicPoint().x + 1, super.getBasicPoint().y - 1);
                mCoord3.set(super.getBasicPoint().x + 2, super.getBasicPoint().y - 1);
            ...
            case "Rotate_180_degrees" :
                super.setBasicPoint(super.getBasicPoint().x + 1, super.getBasicPoint().y);
                mCoord1.set(super.getBasicPoint().x - 1, super.getBasicPoint().y - 2);
    ...
    public Figure_L_Left clone() {
        Figure_L_Left o = (Figure_L_Left) super.clone();
