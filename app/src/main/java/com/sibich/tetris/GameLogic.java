  ...
  /*  public void moveLinesDown(int line) {
   ...
   /* public int getLevel() {
    ...
    public void readFromTableGameField() {
        mListFallenFigures.clear();
        // делаем запрос всех данных из таблицы records, получаем Cursor
        Cursor c = mDatabase.query(GameFieldTable.NAME, null, null, null, null, null, null);
        ...
        if (c.moveToFirst()) {
            ...
            int coord1_X_ColIndex = c.getColumnIndex(GameFieldTable.Cols.COORD1_X);
            int coord1_Y_ColIndex = c.getColumnIndex(GameFieldTable.Cols.COORD1_Y);
            int coord2_X_ColIndex = c.getColumnIndex(GameFieldTable.Cols.COORD2_X);
            int coord2_Y_ColIndex = c.getColumnIndex(GameFieldTable.Cols.COORD2_Y);
            int coord3_X_ColIndex = c.getColumnIndex(GameFieldTable.Cols.COORD3_X);
            int coord3_Y_ColIndex = c.getColumnIndex(GameFieldTable.Cols.COORD3_Y);
            int coord4_X_ColIndex = c.getColumnIndex(GameFieldTable.Cols.COORD4_X);
            int coord4_Y_ColIndex = c.getColumnIndex(GameFieldTable.Cols.COORD4_Y);

            int color_ColIndex = c.getColumnIndex(GameFieldTable.Cols.COLOR);
            ...
            if (!figures.isEmpty()) {
                ...
                for (int i = 0; i < figures.size(); i++) {
                    ...
                    switch (figure.getAllCoords().size()) {
                        case 1:
                            values.put(GameFieldTable.Cols.COORD1_X, figure.getAllCoords().get(0).x);
                            values.put(GameFieldTable.Cols.COORD1_Y, figure.getAllCoords().get(0).y);
                            values.put(GameFieldTable.Cols.COORD2_X, -1);
                            values.put(GameFieldTable.Cols.COORD2_Y, -1);
                            values.put(GameFieldTable.Cols.COORD3_X, -1);
                            values.put(GameFieldTable.Cols.COORD3_Y, -1);
                            values.put(GameFieldTable.Cols.COORD4_X, -1);
                            values.put(GameFieldTable.Cols.COORD4_Y, -1);
                            break;
                        case 2:
                            values.put(GameFieldTable.Cols.COORD1_X, figure.getAllCoords().get(0).x);
                            values.put(GameFieldTable.Cols.COORD1_Y, figure.getAllCoords().get(0).y);
                            values.put(GameFieldTable.Cols.COORD2_X, figure.getAllCoords().get(1).x);
                            values.put(GameFieldTable.Cols.COORD2_Y, figure.getAllCoords().get(1).y);
                            values.put(GameFieldTable.Cols.COORD3_X, -1);
                            values.put(GameFieldTable.Cols.COORD3_Y, -1);
                            values.put(GameFieldTable.Cols.COORD4_X, -1);
                            values.put(GameFieldTable.Cols.COORD4_Y, -1);
                        ...
                        case 3:
                            ...
                            values.put(GameFieldTable.Cols.COORD2_X, figure.getAllCoords().get(1).x);
                            values.put(GameFieldTable.Cols.COORD2_Y, figure.getAllCoords().get(1).y);
                            values.put(GameFieldTable.Cols.COORD3_X, figure.getAllCoords().get(2).x);
                            values.put(GameFieldTable.Cols.COORD3_Y, figure.getAllCoords().get(2).y);
                            values.put(GameFieldTable.Cols.COORD4_X, -1);
                            values.put(GameFieldTable.Cols.COORD4_Y, -1);
                            break;
                        case 4:
                            ...
                            values.put(GameFieldTable.Cols.COORD3_X, figure.getAllCoords().get(2).x);
                            values.put(GameFieldTable.Cols.COORD3_Y, figure.getAllCoords().get(2).y);
                            values.put(GameFieldTable.Cols.COORD4_X, figure.getAllCoords().get(3).x);
                            values.put(GameFieldTable.Cols.COORD4_Y, figure.getAllCoords().get(3).y);
                            break;
                    }

                    values.put(GameFieldTable.Cols.COLOR, figure.getColor());

                    mDatabase.insert(GameFieldTable.NAME, null, values);
                    values.clear();
                }
    ...
    public void deleteAllRowsInTableGameField() {
        mDatabase.delete(GameFieldTable.NAME, null, null);
    }
